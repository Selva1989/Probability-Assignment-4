...
def simulation_without_antibiotic(num_bacteria,
    ...
    make_one_curve_plot(get_x_coords(), get_y_coords(), "Timestep", " Average Bacteria Population", "Without antibiotic")
...
def simulation_with_antibiotic(num_bacteria,
    ...
    y = get_y_coords()
    make_two_curve_plot(get_x_coords(), y[0], y[1],"Resistant Bacteria Population", "Total Bacteria population", "Timesteps", "Average Bacteria Population", "With an antibiotic")
...
Before introducing the antibiotic, the average population of the bacteria gradually increases 
and maintains a stable level with respect to timesteps, further without introducing antibiotic, the average population of 
the bacteria doesn't decreases.

After introducing the antibiotic, the Simulation A graph shows there is decrease in the resistant bacteria population 
when compared to the total population of the bacteria.

In Simulation B graph shows there is a gradual increase in resistant bacteria population but the total bacteria population
gets decreased rapdily after reaching certain timesteps. """